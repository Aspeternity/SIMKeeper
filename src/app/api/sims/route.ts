...
const rowSelection = {
  ...
  tariffPlanType: simTariffs.planType,
  tariffCurrencyCode: simTariffs.currencyCode,
  tariffRecurringFee: simTariffs.recurringFee,
  tariffRecurringPeriodValue: simTariffs.recurringPeriodValue,
  tariffRecurringPeriodUnit: simTariffs.recurringPeriodUnit,
  tariffAdministrationFee: simTariffs.administrationFee,
  tariffAutoRenew: simTariffs.autoRenew,
